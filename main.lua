...
local locations = {
    ...
    {name = "🗼 โรงพยาบาล", cframe = CFrame.new(3419.51, 14.15, 2583.95)},
    {name = "🕵️ ตลาดมืด", cframe = CFrame.new(3204.26, 14.14, 2308.46)},
    {name = "🏞️ ร้านค้า-ตัวเมือง", cframe = CFrame.new(3022.05, 13.99, 1935.06)},
    {name = "🏫 ร้านขายรถ", cframe = CFrame.new(2913.12, 21.77, 2735.43)},
    {name = "🏥 สถานีตำรวจ", cframe = CFrame.new(3710.08, 14.13, 3572.60)},
    {name = "🚓 แลนแดง", cframe = CFrame.new(2563.22, 14.11, 531.47)},
    {name = "🏢 คริสมาส", cframe = CFrame.new(3857.90, 14.17, 385.22)},
    {name = "🏠 ดอกไม้", cframe = CFrame.new(3027.14, 14.01, -863.75)},
    {name = "🏠 กระหล่ำ", cframe = CFrame.new(2139.79, 14.02, -3332.01)},
    {name = "🛣️ ไม้", cframe = CFrame.new(1264.86, 14.03, -1704.10)},
    {name = "🌉 สตอเบอรี่", cframe = CFrame.new(-85.29, 88.27, -2993.89)},
    {name = "🛫 หิน", cframe = CFrame.new(-321.28, -90.90, -2021.31)},
    {name = "🚢 กล้วย", cframe = CFrame.new(70.07, 14.03, -366.41)},
    {name = "🏜️ แลกมะม่วง", cframe = CFrame.new(1060.44, 14.08, -521.77)},
    {name = "🏔️ ข้าวโพด", cframe = CFrame.new(-231.84, 48.61, 549.42)},
    {name = "🎢 เนื้อหมู", cframe = CFrame.new(-592.87, 14.02, 2340.24)},
    {name = "🧪 มะพร้าว", cframe = CFrame.new(-3321.94, 72.48, 1071.51)},
    {name = "🏬 หญ้า", cframe = CFrame.new(-2294.86, 233.47, 54.01)},
    {name = "🏠 องุ่น", cframe = CFrame.new(-2746.55, 73.01, -955.08)},
    {name = "🗼 พริก", cframe = CFrame.new(-2273.88, 47.32, -2297.65)},
    {name = "🕵️ จุดเบิกรถใกล้กับมะพร้าว", cframe = CFrame.new(-2692.62, 13.02, 3042.81)},
    {name = "🏞️ แปรรูปหิน", cframe = CFrame.new(-1907.78, 13.14, 3199.30)},
